    ...
    Xe = (De.Grid = je.extend({
      ...
      setRange: function (t) {
        ...
        (this.start = t.start.clone()),
          ...
          (this.colData = []),
          this.updateCells(),
          (this.colHeadFormat = this.computeColHeadFormat()),
      ...
      limitRow: function (e, n) {
        ...
        if (n && S.segLevels.length > n) {
          for (
            s = S.segLevels[n - 1],
              o = S.cellMatrix,
              l = S.tbodyEl.children().slice(n).addClass("fc-limited").get(),
              a = 0;
            s.length > a;
            a++
          ) {
